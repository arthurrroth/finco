...
const AddTransaction = () => {
  ...
  <header className="addTransactionHeader">
    <button className="goBackBtn" onClick={() => navigate(-1)}><img src={BackIcon} alt="back"/></button>
  ...
  <main className="addTransactionMain">
    ...
    <form className="addForm" onSubmit={addIncome}>
      <input className="addInput" type="number" id="income" placeholder="€ 12000"/>

      <label className="addLabel" htmlFor="category">Category</label>
      ...
      <section className="dateTimeSection">
        <div className="dateTimeDiv">
          <label className="addLabel" htmlFor="dateInput">Date</label>
        ...
        <div className="dateTimeDiv">
          <label className="addLabel" htmlFor="timeInput">Time</label>
          <div className="customDateTimeInput">
  ...
  <main className="addTransactionMain">
    ...
    <form className="addForm" onSubmit={addExpense}>
      <input className="addInput" type="number" id="expense" placeholder="€ 12000"/>
