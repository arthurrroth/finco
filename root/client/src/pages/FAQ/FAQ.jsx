    ...
    <main className="FAQ">
      ...
      <section>
        ...
        <p>
          ...
          homepage. Fill in the required information, such as your email address
          and password, and follow the prompts to complete the registration
          process.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          details, including card number, expiration date, and CVV. Make sure to
          save the changes.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          Yes, you can categorize your transactions for better expense tracking.
          While adding or editing a transaction, you'll have the option to
      ...
      <section>
        ...
        <p>
          ...
          the XY chart option, select the timeframe you want to analyze, and the
          chart will display your income and expenses based on your recorded
          transactions.
        </p>
      </section>
      <section>
